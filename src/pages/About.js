        ...
        <p className="card-text-about mt-3">You can call me Bax; I'm an aspiring <span className="fw-bold">Front End Developer &nbsp;</span> 
         ...
         <h5 className="text-center skills-about">EXPERIENCE</h5>
            ...
            <ul className="about-list"> 
                ...
                <li className="list" id="ht" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="Top popover" title="HTML"><i class="fa-brands fa-html5 fa-html5 fa-bounce fa-2xl"></i></li>
                ...
                <li className="list" id="fig" data-bs-toggle="tooltip" data-bs-placement="top" title="IONIC"><img src={Ionic} className="img-fluid" alt="figmalogo"/></li>
            </ul>
